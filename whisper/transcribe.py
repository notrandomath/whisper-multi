    ...
    **decode_options,
    ...
    def decode_with_fallback(segment: torch.Tensor) -> DecodingResult:
        ...
        for t in temperatures:
            ...
            # if returning groups, keep each group
    ...
    with tqdm.tqdm(
        ...
        while clip_idx < len(seek_clips):
            ...
            # turn results into a list of groups, store group into flattened list of segments
            result_raw: Union[DecodingResult, List[DecodingResult]] = decode_with_fallback(mel_segment)
            if not isinstance(result_raw, list):
                result_raw = [result_raw]

            for k, result in enumerate(result_raw):
